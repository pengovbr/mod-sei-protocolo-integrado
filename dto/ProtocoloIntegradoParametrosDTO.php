...
class ProtocoloIntegradoParametrosDTO extends InfraDTO {
  ...
  public function getStrNomeTabela() {
  	 return 'protocolo_integrado_parametros';
  }

  public function montar() {
  	
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdProtocoloIntegradoParametros', 'id_protocolo_integrado_parametros');
