...
try {
  ...
  switch ($_GET['acao']) {
    ...
    case 'md_pi_monitoramento':
      $strTitulo = 'Monitoramento de Integra��o';
      break;
  ...
  if ($numRegistros > 0) {
    ...
    $strResultado .= '<th class="infraTh">' . PaginaSEI::getInstance()->getThOrdenacao($objPacoteEnvioDTO, 'Data da Situa��o', 'DataSituacao', $arrObjPacotesMonitoradosDTO) . '</th>' . "\n";
    if ($bolColunaArquivo) {
    ...
    foreach ($arrObjPacotesMonitoradosDTO as $key => $pacote) {
      ...
      switch (trim($pacote['sta_integracao'])) {
        ...
        case ProtocoloIntegradoPacoteEnvioRN::$STA_NAO_INTEGRADO:
          $strResultado .= '<td width="10%" style="font-size:1em"> N�o Integrado </td>';
          break;
  ...
  if ($bolAcaoForcarReenvio && $maxPacotesReenvio > 0) {
    $arrComandos[] = '<input type="button" onclick="forcarReenvio()" name="btnForcar" id="btnForcar" value="For�ar Reenvio" class="infraButton" />';
...
<form id="frmMonitoramentoIntegracaoProcessosLista" method="post" action="<?= PaginaSEI::getInstance()->formatarXHTML(SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao'])) ?>">
  ...
  <div id="divfiltroCodProtocolo" class="infraAreaDados d-flex flex-column flex-md-row mb-2" style="">
    <div class="col-12 col-md-2 mx-0 px-0 pt-1">
      <label id="filtroCodProtocoloLabel" for="filtroCodProtocolo" accesskey="" class="infraLabelOpcional">N� Processo:</label>
    </div>
  ...
  <div id="divSituacaoPesquisa" class="infraAreaDados d-flex flex-column flex-md-row mb-1">
    <div class="col-12 col-md-2 mx-0 px-0 pt-1">
      <label id="lblSituacaoPesquisa" for="selSituacaoPesquisa" accesskey="" class="infraLabelOpcional">Situa��o:</label>
    </div>
    <div class="col-7 col-md-4 pl-0 pl-md-1 pt-1 media">
  ...
  <div id="divPeriodoGeracaoDe" class="infraAreaDados d-flex flex-column flex-md-row mb-1">
    <div class="col-12 col-md-2 mx-0 px-0 pt-1">
      <label id="lblPeriodoGeracaoDe" for="txtPeriodoGeracaoDe" class="infraLabelOpcional">Data de gera��o do processo:</label>
    </div>
  ...
  ?>
    <div style="float:right;padding:0 1.5em">
      <label style="">Quantidade de registros por p�gina</label>
